...
import com.root.nativeCamera.base.BaseApplication;
...
public class SavePictureTask extends AsyncTask<Bitmap, Integer, String> {
    ...
    protected void onPostExecute(final String result) {
        if (result != null)
            MediaScannerConnection.scanFile(BaseApplication.Companion.get(),
    ...
    private String saveBitmap(Bitmap bitmap) {
        ...
        try {
            ...
            e.printStackTrace();
            onPictureSaveListener.onError(e.getMessage());
        }
        return null;
    }
